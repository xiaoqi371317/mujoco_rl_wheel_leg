...
def main():
    ...
    cfg=task.make_cfg(n,play=True,seed=1043,stage=json.loads((args.run/'run.json').read_text()).get('stage','stance'));cfg.seed=2046;cfg.episode_length_s=10.
    ...
    try:
        ...
        out=args.out or args.run/(checkpoint.stem+'_refine_audit.json');out.parent.mkdir(parents=True,exist_ok=True)

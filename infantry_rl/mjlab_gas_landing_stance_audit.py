...
def main():
    ...
    ap.add_argument('--force',type=float,default=200.)
    ...
    try:
        ...
        env._gas_force=torch.full((16,),args.force,device=env.device)
        ...
        with torch.no_grad():
            ...
            report={'force_per_side_N':args.force,'checkpoint':str(args.checkpoint.resolve()),'seconds':30,'measured_after_s':5,'cases':{}}
